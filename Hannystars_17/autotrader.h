...
public:
    ...
    void CancelAskOrder(unsigned long newAskPrice);

    void CancelBidOrder(unsigned long newBidPrice);

    void InsertAskOrder(unsigned long newAskPrice,
                        unsigned long newAskVolume);

    void InsertBidOrder(unsigned long newBidPrice,
...
private:
    ...
    unsigned long mNewBidVolume = 50;
    unsigned long mNewAskVolume = 50;
    signed long mPosition = 0;
    signed long mHedgePosition = 0;
